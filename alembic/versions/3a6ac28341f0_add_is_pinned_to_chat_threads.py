"""add is_pinned to chat_threads

Revision ID: 3a6ac28341f0
Revises: b5cfa183e5ab
Create Date: 2026-06-22 11:45:49.543856
...
revision: str = '3a6ac28341f0'
down_revision: Union[str, Sequence[str], None] = 'b5cfa183e5ab'
...
def upgrade() -> None:
    ...
    op.add_column('chat_threads', sa.Column('is_pinned', sa.Boolean(), nullable=True))
